...
Stable posture scoring (low noise)  
Live posture feedback (OK / BAD)  
PyQt5 GUI (Desktop App)  
Lightweight & fast (MediaPipe-based)  
Ready for Startup MVP / Industrial prototype
...
Shoulder Imbalance 
Spine Lean / Slouching  
Torso Forward Bend   
Natural Head Movement Filtering   
